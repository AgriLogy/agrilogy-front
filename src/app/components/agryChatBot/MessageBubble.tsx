...
export const AgrilogyMessageBubble = ({
  ...
  const bubbleBg     = message.isError ? errorBubbleBg     : isUser ? userBubbleBg     : asstBubbleBg;
  const bubbleColor  = message.isError ? errorBubbleColor  : isUser ? userBubbleColor  : asstBubbleColor;
  const bubbleBorder = message.isError ? errorBubbleBorder : isUser ? userBubbleBorder : asstBubbleBorder;
