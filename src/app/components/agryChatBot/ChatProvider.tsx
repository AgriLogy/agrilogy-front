  ...
  return (
    <>
      ...
      <Box
        ...
        _hover={{ transform: 'scale(1.08)', boxShadow: '0 6px 24px rgba(56,161,105,0.45)' }}
        _active={{ transform: 'scale(0.96)' }}
        onClick={() => setChatOpen((v) => !v)}
        aria-label={chatOpen ? 'Close assistant' : 'Open Agrilogy assistant'}
        type="button"
      >
        <Box
          as="span"
          ...
          transform={chatOpen ? 'rotate(45deg) scale(0.7)' : 'rotate(0deg) scale(1)'}
        >
          <LeafIcon size={22} />
        </Box>
        ...
        <Box
          ...
          transform={chatOpen ? 'rotate(0deg) scale(1)' : 'rotate(-45deg) scale(0.7)'}
        >
          <CloseIcon size={18} />
        </Box>
